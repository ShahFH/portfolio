...
export default function Projects() {
  ...
  return (
    <div id='project' className="mx-5 md:mx-8 lg:mx-16 mt-10 h-full my-52">
      {/** Card 1 */}
    ...
    <div className="grid md:grid-cols-2 pt-15">
        ...
        <TextReveal className=" text-3xl tracking-tight font-[Work Sans] mb-4" title="BGStrip Web App" />
          <p className="">
